...
export default function Project() {
  ...
  <div className="collapse collapse-arrow join-item border-base-300">
    ...
    <div className="collapse-title font-semibold">Nandi - Robo Soccer Bot</div>
  ...
  <div className="collapse collapse-arrow join-item border-base-300 border">
    ...
    <div className="collapse-title font-semibold">Student Management Portal</div>
    <div className="collapse-content text-sm">
        <p>
  ...
  <div className="collapse collapse-arrow join-item border-base-300 border">
    <input type="radio" name="my-accordion-4" />
    <div className="collapse-title font-semibold">Virtual Judge</div>
    <div className="collapse-content text-sm">
        <p>
